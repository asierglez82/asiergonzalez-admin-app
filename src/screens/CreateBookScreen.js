...
const CreateBookScreen = ({ navigation }) => {
  ...
  // Campos específicos de books (basados en Firebase)
  ...
  const generateUrl = (slug) => {
    if (!slug) return '';
    return `https://asiergonzalez.es/contenthub/book/${slug}`;
  };

  // Función para generar path automáticamente
  const generatePath = (slug) => {
    if (!slug) return '';
    return `/contenthub/book/${slug}`;
  };
        ...
        <View style={styles.contentWrapper}>
          <View style={styles.header}>
            <View style={styles.headerContent}>
              <Text style={[styles.title, { color: '#00ca77' }]}>Nuevo Book</Text>
              <Text style={styles.subtitle}>Crear reseña de libro con assets y contenido por red</Text>
            </View>
            <TouchableOpacity 
          ...
          <View style={styles.grid}>
            <View style={styles.fieldCard}>
              ...
              <View style={styles.fieldContent}>
                <Text style={styles.label}>Portada del Libro (URL)</Text>
                <TextInput
                  style={styles.input}
                  placeholder="https://..."
                ...
                {Platform.OS === 'web' ? (
                  ...
                  >
                    ...
                    <img 
                      ...
                      style={{
                        width: isTablet ? '234px' : isMobile ? '130px' : '312px',
                        height: 'auto',
                        maxHeight: isTablet ? '312px' : isMobile ? '156px' : '416px',
                        objectFit: 'contain',
                        borderRadius: '8px',
                    ...
                    {author && (
                      <div style={{
                        position: 'absolute',
                        bottom: isTablet ? '195px' : isMobile ? '185px' : '215px',
                        left: '50%',
                        transform: 'translateX(-50%)',
                        color: '#333b4d',
                  ...
                  <ViewShot ref={composeRef} style={[styles.composeContainer, isTablet && styles.composeContainerTablet, isMobile && styles.composeContainerMobile]} options={{ format: 'png', quality: 1 }}>
                    <View style={[styles.composeBg, isTablet && styles.composeBgTablet, isMobile && styles.composeBgMobile]}>
                      ...
                      <Image 
                        source={bookImage}
                        style={styles.backgroundBookImage}
                        resizeMode="cover"
                      />
                      ...
                      <Image 
                        source={{ uri: imageUrl }} 
                        style={[styles.bookCoverImage, isTablet && styles.bookCoverImageTablet, isMobile && styles.bookCoverImageMobile]} 
                        resizeMode="contain" 
                      />
            ...
            <View style={styles.fieldCard}>
              ...
              <View style={styles.fieldContent}>
                ...
                <View style={styles.blogFieldGroup}>
                  <Text style={styles.blogFieldLabel}>Link de compra</Text>
                  <TextInput 
                    style={styles.blogInput} 
                    value={buy} 
                    onChangeText={setBuy} 
                ...
                <View style={styles.blogFieldGroup}>
                  ...
                  <TextInput 
                    ...
                    placeholder="/assets/books/productmanangersurvival.png" 
                    placeholderTextColor="rgba(255,255,255,0.4)" 
                    editable={false}
                  />
                  {uploadedImagePath && (
                ...
                <View style={styles.blogFieldGroup}>
                  ...
                  <TextInput 
                    ...
                    placeholder="/contenthub/book/productmanangersurvival" 
                    placeholderTextColor="rgba(255,255,255,0.4)" 
                  />
                </View>
                ...
                <View style={styles.blogFieldGroup}>
                  ...
                  <TextInput 
                    ...
                    value={url} 
                    onChangeText={setUrl} 
                    placeholder="https://asiergonzalez.es/contenthub/book/productmanangersurvival" 
                    placeholderTextColor="rgba(255,255,255,0.4)" 
                  />
                </View>
                ...
                <View style={styles.blogFieldGroup}>
                  ...
                  <TextInput 
                    style={styles.blogInput} 
                    value={`${slug}_book_view`} 
                    onChangeText={() => {}} 
                    placeholder="productmanangersurvival_book_view" 
                    placeholderTextColor="rgba(255,255,255,0.4)" 
                    editable={false}
                  />
                </View>
...
const styles = StyleSheet.create({
  ...
  bookCoverImageTablet: {
    width: 234,
    maxHeight: 312,
  },
  bookCoverImageMobile: {
    width: 130,
    maxHeight: 156,
  },
  composeTitle: {
